...
the per user application data directory. On Windows that directory is already
readable only by the user it belongs to and by administrators, which is the same
protection the tools' own credential files get.
...
def credentials_path() -> Path:
	...
	return root / APP_DIR_NAME / CREDENTIALS_FILE
